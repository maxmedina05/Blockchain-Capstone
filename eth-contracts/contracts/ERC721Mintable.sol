...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(
            msg.sender == _owner,
            "Only the contract owner can access this"
        );
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            tokenOwner != to,
            "Given address cannot be the owner of the given token"
        );
        require(
            msg.sender == getOwner() ||
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0x0), "To address is not a valid address");
...
contract CustomERC721Token is
    ERC721Metadata(
        "Custom Real Estate Token",
        "CRET",
        "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"
    )
{
    // TokenURI is not used so it was removed.
